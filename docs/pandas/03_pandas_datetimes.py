...
Original file is located at
    https://colab.research.google.com/drive/1ZP8Jar29sqoFuOYhMFDSuACR1mH5cKSe
"""
...
# df_datetimes.describe(include=['datetime'], datetime_is_numeric=True)       # datetime : 수치형
df_datetimes.describe(include=['datetime'], datetime_is_numeric=False)        # datetime : 범주형
...
df_startday_compose = df_datetimes[['신청일_datetime_month','신청일_datetime_week', '신청일_datetime_quarter']][:2]
